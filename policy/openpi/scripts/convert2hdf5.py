...
def convert(hdf5_paths, output_path, start_index=0):
    ...
    for hdf5_path in hdf5_paths:
        ...
        with h5py.File(hdf5_output_path, "w") as f:
            ...
            images.create_dataset('cam_high', data=cam_high)
            images.create_dataset('cam_left_wrist', data=cam_left_wrist)
            images.create_dataset('cam_right_wrist', data=cam_right_wrist)
...
if __name__ == "__main__":
    ...
    parser.add_argument('outout_path', type=str,default=None,
                        help='output path commanded like datasets/HDF5/...')
    ...
    if output_path is None:
        ...
        output_path = f"./datasets/HDF5/{data_config['task_name']}"
